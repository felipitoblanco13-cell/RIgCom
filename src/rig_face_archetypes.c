...
static RigFaceIrisDetail iris_blue_green__rig_dup_023855af(void) {
...
static RigFaceIrisDetail iris_brown_dark__rig_dup_85216e35(void) {
    RigFaceIrisDetail i = {0};
...
static RigFaceIrisDetail iris_amber_hazel__rig_dup_e5bb738e(void) {
    RigFaceIrisDetail i = {0};
...
static RigFaceIrisDetail iris_midnight__rig_dup_1d5bc2b9(void) {
    RigFaceIrisDetail i = {0};
...
static RigFaceEarParams ear_default__rig_dup_0a21103c(bool right) {
...
static RigFaceLipDetail lip_neutral__rig_dup_8a31f5c7(float gender_factor) {
...
const RigFaceArchetype* rig_archetype_get__rig_dup_49442146(RigArchetypeID id)
{
...
const char* rig_archetype_category_name__rig_dup_c35e7552(RigArchetypeCategory cat)
{
...
RigFaceParams rig_archetype_blend_params__rig_dup_c1b475a9(RigArchetypeID id_a,
                                          RigArchetypeID id_b,
                                          float t)
{
    init_archetypes__rig_variant_51bb7d47();
    const RigFaceArchetype *a = rig_archetype_get__rig_dup_49442146(id_a);
    const RigFaceArchetype *b = rig_archetype_get__rig_dup_49442146(id_b);
...
int rig_archetype_search__rig_variant_032d740d(const char *tag, RigArchetypeID *out, int max_results)
{
    init_archetypes__rig_variant_51bb7d47();
    int found = 0;
...
RigFaceMesh* rig_face_from_archetype_v1__rig_dup_11e057dd(RigArchetypeID id)
{
