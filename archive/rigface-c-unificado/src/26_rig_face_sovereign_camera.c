/* ==========================================================================
 * 26_rig_face_sovereign_camera.c   —   RIGFACE :: C UNIFICADO
 *
 * Copia canonica : nested/Face_Pose_Body/rig_face_sovereign_camera.c
 * Copias fundidas: 5
 * Funciones      : 10      Unidades injertadas: 0      Variantes: 0
 *
