/* ==========================================================================
 * 29_rig_face_v2.c   —   RIGFACE :: C UNIFICADO
 *
 * Copia canonica : nested/16_FACE_NG-1/16_FACE_NG/src/rig_face_v2.c
 * Copias fundidas: 7
 * Funciones      : 81      Unidades injertadas: 23      Variantes: 22
 *
...
float (*rigpub_rig_face_engine_v2_v2_noise)(uint32_t seed, float x, float y) = v2_noise;
...
float (*rigpub_rig_face_engine_v2_v2_snoise)(uint32_t s, float x, float y) = v2_snoise;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
float (*rigpub_rig_face_engine_v2_v2_simplex)(float x, float y) = v2_simplex;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
float (*rigpub_rig_face_engine_v2__hash2)(uint32_t seed, uint32_t idx) = _hash2;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
uint8_t (*rigpub_rig_face_engine_v2__vertex_region)(const RigFaceVertex *v) = _vertex_region;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
float (*rigpub_rig_face_v2_fc_clamp)(float v, float lo, float hi) = fc_clamp;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
float (*rigpub_rig_face_v2_fc_lerp)(float a, float b, float t) = fc_lerp;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
float (*rigpub_rig_face_v2_fc_smoothstep)(float e0, float e1, float x) = fc_smoothstep;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
void (*rigpub_rig_face_v2_bridge_b4_str)(const char *j, const char *k, char *out, size_t sz) = b4_str;
/* RIGCOM_PUBLIC_STATIC_EXPORT_END */
...
/* [fusion] prototype rig_face_destroy <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:19 :: absorbido de rig_face_engine_v2 */
extern int          rig_face_destroy(RigFaceMesh *mesh);

/* [fusion] function rig_face_v2_mouth_geo__v2 <- nested/rig_face_v2_bridge/rig_face_v2.c:524 :: cuerpo divergente; ausente en la copia canonica */
int rig_face_v2_mouth_geo__v2(const RigFaceMouthCtx *ctx, RigArtResultV4 *out)
{
    if (!ctx || !out) return -1;
    char *frag = (char*)malloc(FACE_SHADER_BUF);
    char *js   = (char*)malloc(FACE_JS_BUF);
...
/* [fusion] function fc_lerp__v2 <- src_raw/rig_face_v2.c:27 :: cuerpo divergente; ausente en la copia canonica */
static float __attribute__((unused)) fc_lerp__v2(float a, float b, float t) { return a + (b - a) * t; }

/* [fusion] function fc_smoothstep__v2 <- src_raw/rig_face_v2.c:28 :: cuerpo divergente; ausente en la copia canonica */
static float __attribute__((unused)) fc_smoothstep__v2(float e0, float e1, float x) {
    float t = fc_clamp((x - e0) / (e1 - e0), 0.0f, 1.0f);
    return t * t * (3.0f - 2.0f * t);
}

/* [fusion] function v2_noise__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:25 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
static inline float v2_noise__v2(uint32_t seed, float x, float y)
{
    uint32_t h = seed;
...
/* [fusion] function rig_face_v2_create__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:64 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
RigFaceMeshV2 *rig_face_v2_create__v2(const RigFaceParams *params,
                                    uint32_t subdiv)
{
    if (!params) return NULL;
    if (subdiv < 2) subdiv = 2;
...
/* [fusion] function rig_face_v2_destroy__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:135 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_v2_destroy__v2(RigFaceMeshV2 *m)
{
    if (!m) return -1;
...
/* [fusion] function rig_face_build_pore_system__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:155 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_pore_system__v2(RigFaceMeshV2 *m, float density_scale)
{
...
/* [fusion] function rig_face_build_vascular_tree__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:214 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_vascular_tree__v2(RigFaceMeshV2 *m)
{
    if (!m) return -1;
...
/* [fusion] function rig_face_build_wrinkle_lines__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:254 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_wrinkle_lines__v2(RigFaceMeshV2 *m, float age,
                                   float expression)
{
    if (!m) return -1;
...
/* [fusion] function rig_age_apply_to_mesh__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:325 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_age_apply_to_mesh__v2(RigFaceMeshV2 *m, float age_years)
{
    if (!m) return -1;
    if (age_years <  0.0f) age_years =  0.0f;
    if (age_years > 100.0f) age_years = 100.0f;
...
/* [fusion] function rig_face_build_iris_geometry__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:402 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_iris_geometry__v2(RigFaceMeshV2 *m, bool right)
{
    if (!m) return -1;
...
/* [fusion] function rig_face_bake_iris_texture__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:413 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_bake_iris_texture__v2(const RigFaceIrisDetail *iris,
                                 uint8_t *out_rgba, uint32_t w, uint32_t h)
{
...
/* [fusion] function rig_iris_set_pupil_dilation__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:447 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_iris_set_pupil_dilation__v2(RigFaceIrisDetail *iris, float lux)
{
    if (!iris) return -1;
...
/* [fusion] function rig_face_build_ear_geometry__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:471 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_ear_geometry__v2(RigFaceMeshV2 *m, bool right)
{
    if (!m) return -1;
    RigFaceEarParams *ep = right ? &m->ear_right_params : &m->ear_left_params;
    uint32_t n_verts = 128, n_tris = 220;
...
/* [fusion] function rig_face_attach_ears__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:519 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_attach_ears__v2(RigFaceMeshV2 *m)
{
    if (!m) return -1;
    if (!m->ear_left_verts)  rig_face_build_ear_geometry(m, false);
...
/* [fusion] function rig_face_sculpt_lips_v2__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:548 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_sculpt_lips_v2__v2(RigFaceMeshV2 *m)
{
...
/* [fusion] function rig_face_bake_lip_color_map__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:567 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_bake_lip_color_map__v2(const RigFaceMeshV2 *m,
                                  uint8_t *out_rgba, uint32_t w, uint32_t h)
{
...
/* [fusion] function rig_face_bake_pore_normal_map__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:617 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_bake_pore_normal_map__v2(RigFaceMeshV2 *m, uint32_t w, uint32_t h)
{
    m->texture_width = w; m->texture_height = h;
    rig_face_build_pore_system(m, 1.0f);
...
/* [fusion] function rig_face_bake_vascular_map__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:623 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_bake_vascular_map__v2(RigFaceMeshV2 *m, uint32_t w, uint32_t h)
{
    m->texture_width = w; m->texture_height = h;
    rig_face_build_vascular_tree(m);
    return 0; /* 0=hook procesado, -1=contexto inválido */
...
/* [fusion] function rig_face_bake_wrinkle_normal_map__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:629 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_bake_wrinkle_normal_map__v2(RigFaceMeshV2 *m, uint32_t w, uint32_t h)
{
    m->texture_width = w; m->texture_height = h;
    rig_face_build_wrinkle_lines(m, m->base.params.age_factor, 0.0f);
    return 0; /* 0=hook procesado, -1=contexto inválido */
...
/* [fusion] function rig_face_build_follicle_map__v2 <- nested/rig_face_v2_bridge/rig_face_engine_v2.c:734 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_follicle_map__v2(RigFaceMeshV2 *mesh,
                                   const RigHairRegionParams *hair){
...
/* [fusion] function rig_face_build_ear_geometry__v3 <- nested/Face_Pose_Body/rig_face_engine_v2.c:471 :: cuerpo divergente; absorbido de rig_face_engine_v2 */
int rig_face_build_ear_geometry__v3(RigFaceMeshV2 *m, bool right)
{
    if (!m) return -1;
    RigFaceEarParams *ep = right ? &m->ear_right_params : &m->ear_left_params;
    uint32_t n_verts = 128, n_tris = 220;
