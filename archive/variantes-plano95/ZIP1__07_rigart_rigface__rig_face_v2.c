                              ...
                              RIgArtFaceSessionV2 *session)
{
    ...
    if (strcmp(cmd, "rigart_face_build") == 0)
    {
        ...
        uint32_t subdiv = (uint32_t)b4_i__rig_variant_f9018f24(payload, "\"subdiv\"", 4);
        if (subdiv < 2) subdiv = 2;
        if (subdiv > 6) subdiv = 6;
    ...
    {
        int arch_id = b4_i__rig_variant_f9018f24(payload, "\"id\"", 0);
    ...
    if (strcmp(cmd, "rigart_face_codegen") == 0)
    {
        ...
        b4_str__rig_variant_bac1b7fc(payload, "\"target\"", target_str, sizeof(target_str));
